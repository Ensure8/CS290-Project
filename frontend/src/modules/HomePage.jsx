    ...
    return (
        <>
            ...
            <article>
                ...
                <p>
                    For this website, several technologies were used to make it functional, stylistic, and dynamic.
                </p>
                <dl>
                    ...
                    <dd>Cascading Style Sheets was used in this website in order to style and structure the frontend by providing different property values for the different elements and widgets shown.</dd>
                    <dt><strong>Javascript</strong></dt>
                    <dd>JavaScript was used to create interactive web pages and to give dynamic functionality to the website. This gave users a more fluid experience when interacting with it.</dd>
                    ...
                    <dd>MongoDB was a non-relation NoSQL database used for storing data through “documents” in a JSON-like format. In this case, game documents containing information about the title, installment, and publish date were stored.</dd>
                </dl>
            </article>
        </>
    )
